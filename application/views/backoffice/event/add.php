<section class="row">
    ...
    <fieldset>
        ...
        <div class="input-field">
            <input id="eventName" name="eventName" type="text" class="validate" required="required" value="<?= set_value('eventName'); ?>">
            <label for="clubName">Nom de l'événement</label> 
        </div>

        <!-- Text input-->
        <div class="input-field">
            <textarea class="materialize-textarea" id="eventDescription" name="eventDescription" required="required" ><?= set_value('eventDescription'); ?></textarea>
        ...
        <!-- Text input-->
        <div class="input-field">
            <input id="address" name="address" type="text" class="validate" required="required" value="<?= set_value('address'); ?>">
        ...
        <div class="row"> 
            <div class="input-field col s6">
                <input id="addPostcode" name="addPostcode" type="number" min="0" class="validate" required="required" value="<?= set_value('addPostcode'); ?>">
            ...
            <div class="input-field col s6">
                <input id="addLocalite" name="addLocalite" type="text" class="validate" required="required" value="<?= set_value('addLocalite'); ?>">
