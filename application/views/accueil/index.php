...
<div class="orange accent-3 well-pad" id="who">
    <div class="container">
        <div class="section">
    ...
    <div class="col m6 article-mosaic">
        <div class="row">
            ...
            <div class="col m4">
                <article class="card hoverable">
                    <div class="card-image">
                        <img src="<?= base_url(); ?>assets/images/libre/running.jpg" alt="article" class="responsive-img">
                    </div>
                    <div class="caption">
                        <h3 class="center-align">Titre de l'article</h3>
                    </div>
            ...
            <div class="col m4">
                <article class="card hoverable">
                    <div class="card-image">
                        <img src="<?= base_url(); ?>assets/images/libre/couloirSprint.jpg" alt="article" class="responsive-img">
                    </div>
                    <div class="caption">
                        <h3 class="center-align">Titre de l'article</h3>
                    </div>
