...
(28, 67, 10, 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.\n\nPhasellus in felis. Donec semper sapien a libero. Nam dui.\n\nProin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.', '2016-11-03 07:56:31'),
...
INSERT INTO `demandes` (`id`, `user_id`, `category_id`, `dossard`, `creation_date`) VALUES
(2, 2, 7, 3052, '2017-06-06 10:24:42'),
(3, 3, 2, 4551, '2017-06-06 10:24:42'),
(4, 4, 2, 2526, '2017-06-06 10:24:42'),
(5, 5, 6, 2802, '2017-06-06 10:24:42'),
(6, 6, 2, 2877, '2017-06-06 10:24:42'),
(7, 7, 6, 4491, '2017-06-06 10:24:42'),
(8, 8, 7, 2428, '2017-06-06 10:24:42'),
(9, 9, 2, 2538, '2017-06-06 10:24:42'),
(10, 10, 4, 2742, '2017-06-06 10:24:42'),
(11, 11, 1, 2545, '2017-06-06 10:24:42'),
(12, 12, 2, 2883, '2017-06-06 10:24:42'),
(13, 13, 5, 2078, '2017-06-06 10:24:42'),
(14, 14, 2, 2536, '2017-06-06 10:24:42'),
(15, 15, 3, 3846, '2017-06-06 10:24:42'),
(16, 16, 2, 4085, '2017-06-06 10:24:42'),
(17, 17, 6, 4878, '2017-06-06 10:24:42'),
(18, 18, 6, 3319, '2017-06-06 10:24:42');
...
(1, 2, 'adoyland0', '$2y$10$F7VYssPqLzdOyEPV61l.MOaHAEW4yiVxsMP.XBa6fiWDxtvdzjKtS', 'lyesichev0@dion.ne.jp', NULL, '2016-09-27 05:54:28'),
(2, 1, 'jtheobald1', 'a0ff7126fc16c2459f64881d3fd6040c', 'kricciardiello1@cnn.com', NULL, '2016-11-17 10:03:50'),
(3, 1, 'tmacgillacolm2', '5e0b11e1346e422609583efd7bb709db', 'ctruss2@chronoengine.com', NULL, '2016-09-24 00:05:31'),
(4, 1, 'lpitkin3', 'd7b3dbc2286271ddac6d60bbb191281d', 'ktennison3@cam.ac.uk', NULL, '2016-07-09 12:32:14'),
(5, 1, 'rchecketts4', '3c7c23b41fe11acff6f2fe793da45ef1', 'abunce4@ocn.ne.jp', NULL, '2016-07-03 06:39:11'),
...
(10, 1, 'jmiliffe9', 'ce208ce23d94ebe5659563d6ba640b23', 'ypiwall9@webs.com', NULL, '2016-11-21 21:15:42'),
...
(14, 1, 'obertenshawd', '2b679fd9b69d5fa35649b77bdb69bbc1', 'kbreydind@dedecms.com', NULL, '2017-05-22 06:38:52'),
...
(76, 1, 'rbosward23', '5f2f34698334c9058a9f1e4cd5aeaece', 'amonck23@yale.edu', NULL, '2017-03-28 04:33:07'),
...
(81, 1, 'agowenlock28', 'c20723dead9a9ca18505ed050fe84503', 'tdrummond28@jigsy.com', NULL, '2017-02-16 06:28:28'),
(82, 1, 'bchaplyn29', 'ff6c0857fc80791f575bb5fc4fbdf3b3', 'pochterlonie29@europa.eu', NULL, '2016-07-20 22:42:37'),
...
(136, 2, 'tbarrelly', 'a27d7184e1a029ea137e43c40d934f0f', 'dhuntlyy@parallels.com', NULL, '2017-01-06 00:01:01'),
...
--
ALTER TABLE `athletes`
  ADD CONSTRAINT `athletes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `demandes`
  ADD CONSTRAINT `demandes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `results`
  ADD CONSTRAINT `results_ibfk_1` FOREIGN KEY (`athlete_id`) REFERENCES `athletes` (`id`) ON UPDATE CASCADE,
